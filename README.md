...
1. **Admissions**
   - Users submit new admission forms.
   - Workflow routes records for approval and verification.

2. **Student Progress**
   - Faculty updates marks and percentages.
   - Automated scripts calculate performance.

3. **Notifications**
   - System sends confirmation and status updates via email.
...
2. Navigate to **Educational Organization → Admissions**.  
3. Create a new admission record.  
4. Open **Student Progress** to update student marks.  
...
<img width="1920" height="1020" alt="image" src="https://github.com/user-attachments/assets/5d7122c9-25d8-48ed-a95c-317e5f661404" />
